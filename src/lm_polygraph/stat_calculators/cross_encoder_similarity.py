...
class CrossEncoderSampleSimilarityMatrixCalculator(StatCalculator):
    """
...
class CrossEncoderTokenSimilarityMatrixCalculator(StatCalculator):
    """
    Calculates the cross-encoder similarity matrix for generation samples using RoBERTa model.
    """
    ...
    def __call__(
        ...
        return {"token_similarity": batch_token_scores}
